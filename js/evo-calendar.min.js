	...
	(i = 0),
		...
		(r.prototype.destroy = function () {
			...
			e.destroyEventListener(),
				...
				e.$elements.calendarEl.attr(
					"class",
					e.initials.default_class
				),
		...
		(r.prototype.buildCalendar = function () {
			...
			t.calculateDays(),
				(r = t.formatDate(
					new Date(
						t.$label.months[t.$active.month] + " 1 " + t.$active.year
					),
		...
		(r.prototype.addEventIndicator = function (t) {
			...
			function d(e) {
				0 ===
					...
					0 ===
						n.find("span.event-indicator > .type-bullet > .type-" + o)
							.length &&
